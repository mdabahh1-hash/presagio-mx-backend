...
ALL_TABLES = (
    "leaderboard_avisos, leaderboard_mes_filas, leaderboard_meses, league_predictions, league_cycle_standings, league_cycle_markets, league_cycles, league_members, leagues, "
    "resolution_plans, seed_plans, review_plans, passkeys, market_proposals, points_ledger, follows, price_history, comments, positions, trades, market_outcomes, markets, users"
)
